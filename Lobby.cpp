...
int Lobby::redImageNumber = 0;
int Lobby::blueImageNumber = 0;
int Lobby::mapImageNumber = 0;
bool isGameStart = false;

Lobby::Lobby(const string name, const ObjectData::POSITION pos, const ObjectData::SIZE size, int hNumber, int vNumber, HBITMAP hBitmap)
...
void Lobby::Render(HDC hDC, HDC memDc)
{
